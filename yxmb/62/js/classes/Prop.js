 ...
 * text
 */
(function() {var Prop = function(cfg) {/**
 * text
 */
 this.name = '';
 ...
 * Initialize
 */
 Prop.prototype.init = function() {var propsTypes = ['prop_spring01', 'props_balloon', 'props_gliding01', 'props_michael', 'props_super', 'props_ufo'];
 var propsLists = {prop_spring01: {width: 41,
 height: 14},
 props_balloon: {width: 54,
 height: 64},
 props_gliding01: {width: 75,
 height: 64},
 props_michael: {width: 80,
 height: 45},
 props_super: {width: 58,
 height: 84},
 props_ufo: {width: 71,
 height: 44}};
 ...
 */
 Prop.prototype.stepon = function(donkey) {if(this.__isStepon) {return false;}
 this.__isStepon = true;

 switch(this.name) {case 'prop_spring01':
 ...
 if(this.name == 'prop_spring01') {var anim = new my.Animation({image: my.ImageManager.get('prop_spring03'),
 frames: getPropFrames('prop_spring03'),
 loop: false});
 anim.init();
 this.anim = anim;
 this.height = 30;
 this.y -= 16;} else {this.destory();}}
